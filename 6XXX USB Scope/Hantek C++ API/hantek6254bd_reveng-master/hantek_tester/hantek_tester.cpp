...
constexpr int TIME_PER_DIVISION = 7; //20 uS
...
constexpr double SAMPLING_RATE_SINGLE[36] = { 1E9, 1E9, 1E9, 1E9, 1E9, 1E9, 1E9, 500E-6, 250E-6, 125E-6, 50E-6, 25E-6, 12.5E-6, 5E6, 2.5E6, 1.25E6, 500E3, 250E3, 125E3, 50E3, 25E3, 12.5E3, 5E3, 2.5E3, 1.25E3, 500, 250, 125, 50, 25, 12.5, 5, 2.5, 1.25, 0.5, 0.25 };
constexpr double SAMPLING_RATE_DUAL[36] =   { 500E-6, 500E-6, 500E-6, 500E-6, 500E-6, 500E-6, 500E-6, 500E-6, 250E-6, 125E-6, 50E-6, 25E-6, 12.5E-6, 5E6, 2.5E6, 1.25E6, 500E3, 250E3, 125E3, 50E3, 25E3, 12.5E3, 5E3, 2.5E3, 1.25E3, 500, 250, 125, 50, 25, 12.5, 5, 2.5, 1.25, 0.5, 0.25 };
constexpr double SAMPLING_RATE_QUAD[36] =   { 250E-6, 250E-6, 250E-6, 250E-6, 250E-6, 250E-6, 250E-6, 250E-6, 250E-6, 125E-6, 50E-6, 25E-6, 12.5E-6, 5E6, 2.5E6, 1.25E6, 500E3, 250E3, 125E3, 50E3, 25E3, 12.5E3, 5E3, 2.5E3, 1.25E3, 500, 250, 125, 50, 25, 12.5, 5, 2.5, 1.25, 0.5, 0.25 };
...
short find_and_setup_devs(PCONTROLDATA control_data)
{
    ...
    for (size_t i = 0; i < MAX_USB_DEV_NUMBER-1; i++) {
        if(dev_info[i]) {
            dev_idx = i;
    ...
    for (size_t i = 0; i < MAX_CH_NUM; i++) {
        if (0 == dsoHTSetCHPos(dev_idx, calibration_data, relay_control.nCHVoltDIV[i], CH_ZERO_POS[i], i, ADC_CHANNEL_MODE)) {
...
int main()
{
    ...
    ////Initialize - Continuous Sine Wave
    //if (0 == ddsSetCmd(dev_idx, 0)) {
    //    std::cerr << "Failed to initialize signal generator, aborting." << std::endl;
    //    return EXIT_FAILURE;
    //}
    ////Set Frequency
    //if (0 == ddsSDKSetFre(dev_idx, frequency)) {
    //    std::cerr << "Failed to set signal generator frequency, aborting." << std::endl;
    //    return EXIT_FAILURE;
    //}
    ////Set Amplitude
    //if (0 == ddsSDKSetAmp(dev_idx, amplitude)) {
    //    std::cerr << "Failed to set signal generator amplitude, aborting." << std::endl;
    //    return EXIT_FAILURE;
    //}
    ////Set Offset
    //if (0 == ddsSDKSetOffset(dev_idx, offset)) {
    //    std::cerr << "Failed to set signal generator offset, aborting." << std::endl;
    //    return EXIT_FAILURE;
    //}
